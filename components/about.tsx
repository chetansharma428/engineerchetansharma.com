                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="mt-6 text-md md:text-lg leading-8 text-White-600">
                                ...
                                <Divider className="my-3" />
                                Currently, I am working as a Full Stack Developer, building a full-stack dynamic website from scratch. The project involves designing in Figma, using React for the frontend, Express for the API, SQL for the database, and Node.js for the backend. I have implemented multiple optimization techniques for both website performance and database efficiency. <br/>
                                I'm looking forward to new opportunities to collaborate and create exciting applications that solve real-world problems.
                            </div>
                        </div>
                    </div>
                </div>
