        ...
        <div className="mx-auto max-w-2xl py-24">
          <div className="">
            ...
            <div className="mt-6 text-lg leading-8 text-White-600 ">
              ...
              with extensive experience in building web applications with
              cutting edge technologies. I've a strong foundation in algorithms
              and data structures and I enjoy solving new coding challenges to
              learn and grow my skills to the next level.
            </div>
