...
const Projects = () => {
  const projectss = [
    ...
    },
    {
      ...
      description: ["An old Porfolio website build with angular"],
      tech: ["AngularJS", "TypeScript", "Bootstrap", "css", "Docker"],
      githubLink:
        "https://github.com/chetansharma428/professional_web_portfolio",
      ...
      <div className="relative px-6 pt-14 lg:px-8">
        <div className="text-center">
          <div className="text-4xl text-white-900 py-8">
            Software Applications I’ve Built
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8">
          {projectss.map((project, index) => (
            <div
              key={index}
              className="bg-transparent p-6 rounded-lg shadow-lg flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4"
            >
              ...
              <div className="project-content lg:w-2/5">
                <div className="project-label text-lg font-semibold mb-2 text-teal-300">
                  {project.label}
                </div>
                <h4 className="project-title text-2xl font-bold mb-4 dark:text-white">
                  {project.title}
                </h4>
                <div className="project-details">
                  <div className="description mb-4 dark:text-gray-300">
                    ...
                    {project.demoID && (
                      <p>
                        Demo ID: {project.demoID} <br /> Pass:{" "}
                        {project.password}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="project-links flex space-x-4">
                    ...
                    <Link
                      className="inline-flex items-center px-4 py-2 bg-gray-700 text-white rounded-full hover:bg-gray-600"
